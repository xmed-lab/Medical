...
# @Author  : Anonymous
# @Site    : 
# @File    : save_MNMS_2D.py
# @Software: PyCharm

# #Desc: 2. partially ref DGNET;remember to move unlabel data in Training dirs
...
parser.add_argument('--LabeledVendorA', type=str, default='E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_data/Labeled/vendorA/', help='The root of dataset.')

parser.add_argument('--LabeledVendorBcenter2', type=str, default='E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_data/Labeled/vendorB/center2/', help='The root of dataset.')
parser.add_argument('--LabeledVendorBcenter3', type=str, default='E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_data/Labeled/vendorB/center3/', help='The root of dataset.')

parser.add_argument('--LabeledVendorC', type=str, default='E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_data/Labeled/vendorC/', help='The root of dataset.')

parser.add_argument('--LabeledVendorD', type=str, default='E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_data/Labeled/vendorD/', help='The root of dataset.')

parser.add_argument('--UnlabeledVendorC', type=str, default='E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_data/Unlabeled/vendorC/', help='The root of dataset.')
...
# Save data dirs
LabeledVendorA_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_data/Labeled/vendorA/'
LabeledVendorA_mask_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_mask/Labeled/vendorA/'

LabeledVendorB2_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_data/Labeled/vendorB/center2/'
LabeledVendorB2_mask_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_mask/Labeled/vendorB/center2/'

LabeledVendorB3_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_data/Labeled/vendorB/center3/'
LabeledVendorB3_mask_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_mask/Labeled/vendorB/center3/'

LabeledVendorC_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_data/Labeled/vendorC/'
LabeledVendorC_mask_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_mask/Labeled/vendorC/'

LabeledVendorD_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_data/Labeled/vendorD/'
LabeledVendorD_mask_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_mask/Labeled/vendorD/'

UnlabeledVendorC_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_data/Unlabeled/vendorC/'
...
for num_pat in range(0, len(LabeledVendorA_names)): 
    ...
    img_np = np.transpose(img_np, (0, 1, 3, 2)) # 4D

    if num_pat == 0:
        print(type(img_np[0,0,0,0])) # 一个pixel
