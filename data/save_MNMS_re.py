...
# Save data dirs
LabeledVendorA_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_re/Labeled/vendorA/'

LabeledVendorB2_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_re/Labeled/vendorB/center2/'

LabeledVendorB3_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_re/Labeled/vendorB/center3/'

LabeledVendorC_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_re/Labeled/vendorC/'

LabeledVendorD_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_re/Labeled/vendorD/'

UnlabeledVendorC_data_dir = 'E://Code/Pycharm/Medical/data/OpenDataset/ready/mnms_split_2D_re/Unlabeled/vendorC/'
...
for num_pat in range(0, len(LabeledVendorA_names)):
    ...
    img = nib.load(patient_root) # retrieves the image data as a NumPy array
    img_np = img.get_fdata()

    header = img.header
    resolution = header.get_zooms() # contains metadata about the image itself. voxel;pixdim (1.328125, 1.328125, 9.52, 0.0)
    X_scan_re = []
